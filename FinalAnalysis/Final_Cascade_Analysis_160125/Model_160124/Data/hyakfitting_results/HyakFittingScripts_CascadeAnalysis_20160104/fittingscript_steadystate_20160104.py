...
## collect all of the passed arguments
script_name = sys.argv[0]
output_path = sys.argv[1]

## Make output parameters
save_location = os.path.join(output_path, "solution.csv")
logfile_location = os.path.join(output_path, "log.text")

print script_name, output_path
###########################################################################
########################### Input Parameters ##############################
###########################################################################
...
#dose_response_location =   "ExperimentalData/20151208_211350_doseresponse_plate2.csv"
kinetics_layer1_location = "ExperimentalData//KineticsLayer1.csv"
kinetics_layer2_location = "ExperimentalData/KineticsLayer2.csv"
kinetics_layer3_location = "ExperimentalData/KineticsLayer3.csv"
kinetics_layer4_location = "ExperimentalData/KineticsLayer4.csv"
