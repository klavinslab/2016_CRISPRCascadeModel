...
number_of_replicates = 48
# Make the list
with open('sql_stuff_to_add', 'wb') as submissionfile:

    script_names = ['fittingscript_steadystate_20151209_exp1.py', 'fittingscript_steadystate_20151209_exp2.py']
...
create_parrel_submission_script(writepath=ROOT, workingpath=ROOT, sdoutpath=sdout_path,
                                nameofexperiment='test', cores=16, nodes=1,
                                backfill=False)
