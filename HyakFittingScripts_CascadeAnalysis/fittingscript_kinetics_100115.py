...
logfile_location = "/Users/soslab/Documents/Programming/CRISPRCascadeAnalysis/Data/DiffEvoResults/log.text"
...
fitDoseResponse = False # Use the dose response model to fit the data
best_params_df = None
...
def makelog():
    ...
    logfile_location = logfile_location.split(".")[0] + "_" + tstmp + "." + logfile_location.split(".")[1]
