...
t_final = 100.0
dt = 1.0
save_location = "/Users/soslab/Documents/Programming/CRISPRCascadeAnalysis/Data/DiffEvoResults/test.csv"
dose_response_location = "/Users/soslab/Documents/Programming/CRISPRCascadeAnalysis/Data/ExperimentalData/DoseResponse.csv"
kinetics_layer1_location = "/Users/soslab/Documents/Programming/CRISPRCascadeAnalysis/Data/ExperimentalData/KineticsLayer1.csv"
kinetics_layer2_location = "/Users/soslab/Documents/Programming/CRISPRCascadeAnalysis/Data/ExperimentalData/KineticsLayer2.csv"
kinetics_layer3_location = "/Users/soslab/Documents/Programming/CRISPRCascadeAnalysis/Data/ExperimentalData/KineticsLayer3.csv"
kinetics_layer4_location = "/Users/soslab/Documents/Programming/CRISPRCascadeAnalysis/Data/ExperimentalData/KineticsLayer4.csv"

fitKinetics = True # Use kinetics model to fit the data
...
tstmp = timestamp()
save_location = save_location.split(".")[0] + "_" + tstmp + "." + save_location.split(".")[1]
print "Timestamp:", tstmp
print "Differential Evoluation Fit Settings"
print "\tImport Settings"
print "\t\tUse Kinetics Data:", fitKinetics
print "\t\tUse Dose Response Data:", fitDoseResponse
if fitDoseResponse:
    print "\t\t\tDose Data:", dose_response_location
if fitKinetics:
    print "\t\t\tKinetics Data (1):", kinetics_layer1_location
    print "\t\t\tKinetics Data (2):", kinetics_layer2_location
    print "\t\t\tKinetics Data (3):", kinetics_layer3_location
    print "\t\t\tKinetics Data (4):", kinetics_layer4_location
print "\t\tSave Setings"
print "\t\t\tSave Location:", save_location
print "\tIntegration Settings"
print "\t\ttime_final:", t_final
print "\t\tdt:", dt
print "\tScaling Factors"
print "\t\tau scale:", au_scale
print "\t\ttime scale:", t_scale
print "\tBounds"
print "\t\ta_bounds:", a_bounds
print "\t\tk_bounds:", k_bounds
